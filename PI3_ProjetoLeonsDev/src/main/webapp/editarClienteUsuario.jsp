...
<html>
    <head>
        ...
        <title>Editar cliente usuário </title>
                    ...
                    <div class="box">                           
                        ...
                        <form class="signup" action="${pageContext.request.contextPath}/AtualizarCliente" method="post">
                            ...
                            <div class="form-footer">
                                ...
                                <button class="botoes" type="button"><a href="${pageContext.request.contextPath}/consultarCliente.jsp">CANCELAR</a><span class="fa fa-ban"></span></button>
